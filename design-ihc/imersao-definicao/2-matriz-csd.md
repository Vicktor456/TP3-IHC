...
A Matriz CSD é uma técnica utilizada em fases iniciais de projetos, principalmente em design thinking e planejamento, para estruturar informações e alinhar a visão sobre um desafio.

Ela divide os dados em três categorias:

Certezas (C) → aquilo que já temos comprovado, fatos concretos, informações confirmadas.

Suposições (S) → aquilo que imaginamos ou acreditamos que seja verdade, mas que ainda precisa ser confirmado.
